...
import "package:riverpod_shared_preferences/riverpod_shared_preferences.dart";
import "package:shared_preferences_platform_interface/in_memory_shared_preferences_async.dart";
import "package:shared_preferences_platform_interface/shared_preferences_async_platform_interface.dart";

void main() {
  group("JsonSharedPreferencesWithCacheStorage", () {
    late JsonSharedPreferencesWithCacheStorage storage;
    ...
    setUp(() async {
      ...
      storage = await JsonSharedPreferencesWithCacheStorage.open();
    });
    ...
    test("clears expired keys on creation", () {
      FakeAsync().run((async) async {
        ...
        final aliveKeys = storage.prefs.keys;
